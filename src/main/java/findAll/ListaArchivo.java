...
import VO.BD;
import VO.PersonaVO;
import servicios.ProyectoXpersona;

/**
 *
 * @author Labing I5
 */
public class ListaArchivo extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ProyectoXpersona bd = new ProyectoXpersona();
            ArrayList<ArchivoVO> Archivo = bd.getArchivo();
            String box = "* {\n"
            ...
            content.append("\n"
                    ...
                    + "     <br>\n" + "<pCamuflaje>\n" + "<br>\n"
                    + "         <a class=\"btn btn-primary\" href=Archivo.html></a>\n"
                    + "         <br>\n" + "</pCamuflaje>\n"
                    + "</nav>\n"
                    + "<section>\n"
                    ...
                    + "                         <th>Nombre</th>\n"
                    + "                         <th>EmpresaPatrocina</th>\n"
                    + "                         <th>CoordenadasOrigen</th>\n"
                    + "                 </tr>\n"
                    + "         </thead>\n"
                    + "<tbody>\n");

            for (ArchivoVO archivo : Archivo) {
                content.append(""
                        + "<tr>\n"
                        + "<td>" + archivo.getIdArchivo()+ "</td>\n"
                        + "<td>" + archivo.getFechaRealizacion()+ "</td>\n"
                        + "<td>" + archivo.getNombre(0, pCamuflaje, 0, only_screen)+ "</td>\n"
                        + "<td>" + archivo.getEmpresaPatrocina()+ "</td>\n"
                        + "<td>" + archivo.getCoordenadasOrigen()+ "</td>\n"
                        + "</tr>\n");
            }
            content.append(""
                    + "</tbody>\n"
